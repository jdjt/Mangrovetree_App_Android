...
public final class ProxyBuilder<T> {
	...
	private static final Map<String, ArrayList<com.google.dexmaker.MethodEntity>> proxy = new HashMap<String, ArrayList<com.google.dexmaker.MethodEntity>>();
	...
	private ArrayList<com.google.dexmaker.MethodEntity> methods = new ArrayList<com.google.dexmaker.MethodEntity>();
	...
	public Class<? extends T> buildProxyClass() throws IOException {
		...
		synchronized (baseClass) {
			...
			com.google.dexmaker.DexMaker dexMaker = new com.google.dexmaker.DexMaker(application);
			...
			ArrayList<com.google.dexmaker.MethodEntity> entities = null;
			...
			if (classLoader == null || entities == null) {
				...
				com.google.dexmaker.TypeId<? extends T> generatedType = com.google.dexmaker.TypeId.get("L" + generatedName + ";");
				com.google.dexmaker.TypeId<T> superType = com.google.dexmaker.TypeId.get(baseClass);
				...
				int i = 0;
				for (com.google.dexmaker.MethodEntity entity : entities) {
					Method method = null;
					try {
	...
	private static <T, G extends T> void generateCodeForAllMethods(com.google.dexmaker.DexMaker dexMaker, TypeId<G> generatedType, Method[] methodsToProxy, com.google.dexmaker.TypeId<T> superclassType) {
		com.google.dexmaker.TypeId<InvocationHandler> handlerType = com.google.dexmaker.TypeId.get(InvocationHandler.class);
		com.google.dexmaker.TypeId<Method[]> methodArrayType = com.google.dexmaker.TypeId.get(Method[].class);
		com.google.dexmaker.FieldId<G, InvocationHandler> handlerField = generatedType.getField(handlerType, FIELD_NAME_HANDLER);
		com.google.dexmaker.FieldId<G, Method[]> allMethods = generatedType.getField(methodArrayType, FIELD_NAME_METHODS);
		com.google.dexmaker.TypeId<Method> methodType = com.google.dexmaker.TypeId.get(Method.class);
		com.google.dexmaker.TypeId<Object[]> objectArrayType = com.google.dexmaker.TypeId.get(Object[].class);
		com.google.dexmaker.MethodId<InvocationHandler, Object> methodInvoke = handlerType.getMethod(com.google.dexmaker.TypeId.OBJECT, "invoke", com.google.dexmaker.TypeId.OBJECT, methodType, objectArrayType);
		for (int m = 0; m < methodsToProxy.length; ++m) {
			...
			com.google.dexmaker.TypeId<?>[] argTypes = new com.google.dexmaker.TypeId<?>[argClasses.length];
